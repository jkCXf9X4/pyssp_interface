...
- `main_window.py`
  ...
  - now delegates tree construction and text formatting to focused modules
...
- connector selection directly on the diagram
- connection creation and deletion from the diagram
...
- `MainWindow` still owns too much orchestration logic
- diagram layout is still hardcoded and not persisted
- service tests are stronger than UI tests
- parameter binding editing is still shallow

## Next Refactor Targets

- extract diagram interaction/controller logic out of `MainWindow`
